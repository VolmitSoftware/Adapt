...
public class RedisConfig {
    @ConfigDoc(value = "Synchronizes player data between servers over Redis pub/sub.", impact = "Ignored unless sql.enabled is also true, because Redis only caches data that SQL owns; when enabled the endpoint below must be reachable at startup.")
