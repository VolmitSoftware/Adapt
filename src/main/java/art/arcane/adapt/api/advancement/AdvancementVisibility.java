...
public interface AdvancementVisibility {
  ...
  /**
   * Advancements with this Visibility will be visible once their parent or any
   * of their children is granted
   */
   ...
   * grandparent or any of their children is granted (Similar to Vanilla
   * behavior)
   */
