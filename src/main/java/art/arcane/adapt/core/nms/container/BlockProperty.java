package art.arcane.adapt.core.nms.container;
...
public class BlockProperty {
  ...
  public JSONObject buildJson() {
    art.arcane.volmlib.util.json.JSONObject json = new JSONObject();
    json.put("type", jsonType());
    json.put("default", defaultValueAsJson());
    if (!values.isEmpty()) {
      json.put("enum", valuesAsJson());
    }
    return json;
  }
  ...
  public boolean equals(Object obj) {
    ...
    art.arcane.adapt.core.nms.container.BlockProperty that = (BlockProperty) obj;
