...
public class BrewingHaste extends SimpleAdaptation<BrewingHaste.Config> {
    public BrewingHaste() {
        ...
        registerAdvancement(AdaptAdvancement.builder()
                ...
                .title(Localizer.dLocalize("advancement.challenge_brewing_haste_25.title"))
                .description(Localizer.dLocalize("advancement.challenge_brewing_haste_25.description"))
