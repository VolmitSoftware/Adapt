...
public class AgilitySuperJump extends SimpleAdaptation<AgilitySuperJump.Config> {
    ...
    protected static class Config {
        ...
        @art.arcane.adapt.util.config.ConfigDoc(value = "Controls Show Particles for the Agility Super Jump adaptation.", impact = "True enables this behavior and false disables it.")
