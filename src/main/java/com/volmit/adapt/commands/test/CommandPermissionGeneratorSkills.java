...
public class CommandPermissionGeneratorSkills extends MortarCommand {
    private static final List<String> permission = List.of("adapt.idontknowwhatimdoingiswear");

    public CommandPermissionGeneratorSkills() {
        super("permissionss", "ps");
        this.setDescription("This Prints all skill blacklistable permissions (Skills)");
    }
