...
public class SkillAgility extends SimpleSkill<SkillAgility.Config> {
    public SkillAgility() {
        ...
        registerAdvancement(AdaptAdvancement.builder()
                ...
                .title(Adapt.dLocalize("advancement", "challenge_move_1k", "title"))
                .description(Adapt.dLocalize("advancement", "challenge_move_1k", "description"))
                .frame(AdvancementDisplay.AdvancementFrame.CHALLENGE)
                .visibility(AdvancementVisibility.PARENT_GRANTED)
                .child(AdaptAdvancement.builder()
                        .icon(Material.IRON_BOOTS)
                        .key("challenge_sprint_5k")
                        .title(Adapt.dLocalize("advancement", "challenge_sprint_5k", "title"))
                        .description(Adapt.dLocalize("advancement", "challenge_sprint_5k", "description"))
                        .frame(AdvancementDisplay.AdvancementFrame.CHALLENGE)
                        .visibility(AdvancementVisibility.PARENT_GRANTED).child(AdaptAdvancement.builder()
                                .icon(Material.DIAMOND_BOOTS)
                                .key("challenge_sprint_50k")
                                .title(Adapt.dLocalize("advancement", "challenge_sprint_50k", "title"))
                                .description(Adapt.dLocalize("advancement", "challenge_sprint_50k", "description"))
                                .frame(AdvancementDisplay.AdvancementFrame.CHALLENGE)
                                .visibility(AdvancementVisibility.PARENT_GRANTED).child(AdaptAdvancement.builder()
                                        .icon(Material.NETHERITE_BOOTS)
                                        .key("challenge_sprint_500k")
                                        .title(Adapt.dLocalize("advancement", "challenge_sprint_500k", "title"))
                                        .description(Adapt.dLocalize("advancement", "challenge_sprint_500k", "description"))
                                        .frame(AdvancementDisplay.AdvancementFrame.CHALLENGE)
                                        .visibility(AdvancementVisibility.PARENT_GRANTED)
                                        .build())
                                .build())
                ...
                .child(AdaptAdvancement.builder()
                        ...
                        .title(Adapt.dLocalize("advancement", "challenge_sprint_marathon", "title"))
                        .description(Adapt.dLocalize("advancement", "challenge_sprint_marathon", "description"))
                        .frame(AdvancementDisplay.AdvancementFrame.CHALLENGE)
                        .visibility(AdvancementVisibility.PARENT_GRANTED)
                        .build())
                .build());
