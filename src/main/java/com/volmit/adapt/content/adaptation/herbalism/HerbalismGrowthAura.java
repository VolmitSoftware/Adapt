...
public class HerbalismGrowthAura extends SimpleAdaptation<HerbalismGrowthAura.Config> {
    ...
    public void addStats(int level, Element v) {
        v.addLore(Localizer.dLocalize("herbalism.growth_aura.lore",
                Form.f(getRadius(getLevelPercent(level)), 0),
                Form.pc(getStrength(level), 0),
                Form.f(getFoodCost(getLevelPercent(level)), 2)));
    }
