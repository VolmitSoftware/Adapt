...
public class HunterResistance extends SimpleAdaptation<HunterResistance.Config> {
    public HunterResistance() {
        ...
        setDescription(Adapt.dLocalize("hunter", "resistance", "description"));
        setDisplayName(Adapt.dLocalize("hunter", "resistance", "name"));
    ...
    public void addStats(int level, Element v) {
        v.addLore(C.GRAY + Adapt.dLocalize("hunter", "resistance", "lore1"));
        v.addLore(C.GREEN + "+ " + level + C.GRAY + Adapt.dLocalize("hunter", "resistance", "lore2"));
        v.addLore(C.RED + "- " + 5 + level + C.GRAY + Adapt.dLocalize("hunter", "resistance", "lore3"));
        v.addLore(C.GRAY + "* " + level + C.GRAY + " " + Adapt.dLocalize("hunter", "resistance", "lore4"));
        v.addLore(C.GRAY + "* " + level + C.GRAY + " " + Adapt.dLocalize("hunter", "resistance", "lore5"));
