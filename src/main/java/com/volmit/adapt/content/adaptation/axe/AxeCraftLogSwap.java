...
public class AxeCraftLogSwap extends SimpleAdaptation<AxeCraftLogSwap.Config> {
    ...
    public AxeCraftLogSwap() {
        ...
        registerRecipe(AdaptRecipe.shapeless()
                ...
                .ingredient(Material.BIRCH_LOG)
                .ingredient(Material.BIRCH_LOG)
                .ingredient(Material.CHERRY_SAPLING)
                .result(new ItemStack(Material.CHERRY_LOG, 8))
                .build());
        registerRecipe(AdaptRecipe.shapeless()
                ...
                .ingredient(Material.BIRCH_LOG)
                .ingredient(Material.BIRCH_LOG)
                .ingredient(Material.PALE_OAK_SAPLING) //TODO: Illyrius: @CrazyDev we should add the 1.21.5 version in the build script, so it recognizes the new material.
                .result(new ItemStack(Material.PALE_OAK_LOG, 8)) //TODO: Illyrius: ^
                .build());
        ...
        registerRecipe(AdaptRecipe.shapeless()
                ...
                .ingredient(Material.CHERRY_LOG)
                .ingredient(Material.CHERRY_LOG)
                .ingredient(Material.CHERRY_LOG)
                .ingredient(Material.CHERRY_LOG)
                .ingredient(Material.CHERRY_LOG)
        ...
        //Pale Oak -> Types
        //TODO: Illyrius: @CrazyDev we should add the 1.21.5 version in the build script, so it recognizes the new material.
        registerRecipe(AdaptRecipe.shapeless()
                .key("axe-swappaleoakbirch")
                .ingredient(Material.PALE_OAK_LOG)
                .ingredient(Material.PALE_OAK_LOG)
                .ingredient(Material.PALE_OAK_LOG)
                .ingredient(Material.PALE_OAK_LOG)
                .ingredient(Material.PALE_OAK_LOG)
