...
public class BrewingResistance extends SimpleAdaptation<BrewingResistance.Config> {
    public BrewingResistance() {
        ...
        setDescription(Adapt.dLocalize("brewing", "resistance", "description"));
        setDisplayName(Adapt.dLocalize("brewing", "resistance", "name"));
        ...
        setBrewingRecipes(Lists.newArrayList(BrewingRecipe.builder()
                ...
                .brewingTime(320)
                .fuelCost(16)
                .ingredient(new ItemStack(Material.IRON_INGOT))
