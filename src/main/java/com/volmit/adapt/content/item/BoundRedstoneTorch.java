...
public class BoundRedstoneTorch implements DataItem<BoundRedstoneTorch.Data> {
    ...
    public void applyLore(Data data, List<String> lore) {
        lore.add(Localizer.dLocalize("items.bound_redstone_torch.name"));
        lore.add(Localizer.dLocalize("items.bound_redstone_torch.usage1"));
        lore.add(Localizer.dLocalize("items.bound_redstone_torch.usage2"));
    }
