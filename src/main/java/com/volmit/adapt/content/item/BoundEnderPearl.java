...
public class BoundEnderPearl implements DataItem<BoundEnderPearl.Data> {
    ...
    public void applyLore(Data data, List<String> lore) {
        lore.add(Localizer.dLocalize("items.bound_ender_peral.name"));
        lore.add(Localizer.dLocalize("items.bound_ender_peral.usage1"));
        lore.add(Localizer.dLocalize("items.bound_ender_peral.usage2"));
    }
