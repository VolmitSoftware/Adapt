...
public final class Versions {
    ...
    private static final Map<String, List<String>> NMS_TO_VERSIONS = Map.ofEntries(
            ...
            Map.entry("v1_21_R7", List.of("1.21.11", "26.1", "26.2", "26.3"))
    );
    ...
    private static final Map<String, String> NMS_TO_FANCY = Map.ofEntries(
            ...
            Map.entry("v1_21_R7", "1.21.11, 26.1-26.3")
    );
    ...
    public static String normalizeMinecraftVersion(String version) {
        ...
        if ("26.3".equals(version) || version.startsWith("26.3.") || version.startsWith("26.3-")
                || "26.2".equals(version) || version.startsWith("26.2.") || version.startsWith("26.2-")
