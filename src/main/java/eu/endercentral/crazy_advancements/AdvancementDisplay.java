...
public class AdvancementDisplay {
     ...
     *     Icon {@link Material}
     * @param title
     *     Title {@link JSONMessage}
     * @param description
     *     Description {@link JSONMessage}
     * @param frame
     *     {@link AdvancementFrame}
     * @param showToast
     *     Should toast messages be shown
     * @param announceChat
     *     Should advancements be announced in chat
     * @param visibility
     ...
     *     Player to check
     * @param advancement
     *     Advancement to check (because {@link AdvancementDisplay} is not bound to one advancement)
