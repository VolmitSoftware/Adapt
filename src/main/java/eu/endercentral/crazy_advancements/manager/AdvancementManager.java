...
public final class AdvancementManager {
    ...
    /**
     * Sets the boolean that is passed via the advancement packet when an advancement is hidden<br>Default:
     * false<br>When set to true, hidden advancements that have not been granted yet, will have a line drawn to them
     * even though they aren't displayed yet, when they should be visible (according to their {@link
     * AdvancementVisibility})<br>Can be used to create an empty advancement tab where there are no advancements visible
     * and no lines visible, when the tab only has a hidden advancement as a root
     *
     * @param hiddenBoolean
     *     The new hiddenBoolean
     */
    ...
    /**
     * Set the prefix that is used for criteria<br>For legacy reasons, the default prefix is "criterion." as the
     * advancement progress is stored by their criterion name, which consists of prefix + number<br>To reduce packet
     * size and thus increase the max criteria number that can be used, the prefix can be set to an empty String<br>Only
     * works for advancements that have not generated their criteria yet (use this method before adding advancements to
     * it)
     *
     * @param criterionPrefix
     *     The new prefix that is used for criteria
     */
    ...
    /**
     * Set the namespace that is used for the Namespaced Key for criteria<br>Only works for advancements that have not
     * generated their criteria yet (use this method before adding advancements to it)
     *
     * @param criterionNamespace
     *     The new namespace that is used for the Namespaced Key for criteria
     */
    ...
    /**
     * Sets the key that is used for the Namespaced Key for criteria<br>Only works for advancements that have not
     * generated their criteria yet (use this method before adding advancements to it)
     *
     * @param criterionKey
     *     The new key that is used for the Namespaced Key for criteria
     */
     ...
     *
     * @param advancementsAdded
     *     An array of all advancements that should be added<br>If you want to update the display of an advancement, the
     *     array must have a length of 1
     */
     ...
     * @param player
     *     Player to update
     * @param advancementsUpdated
     *     An array of advancement to update progress
     */
     ...
     *
     * @param player
     *     Player which has received an advancement
     * @param advancement
     *     Advancement Player has received
     */
    ...
    /**
     * @return true if advancement messages will be shown by default in this manager<br>false if advancement messages
     * will never be shown in this manager
     */
     ...
     * @param player
     *     Player to check
     * @param advancementsLoaded
     *     Array of advancements to check, all advancements which arent in the same namespace as the first one will be
     *     ignored
     */
     ...
     * @param advancementsLoaded
     *     Array of advancements to check
     */
